#!/usr/bin/env python3
"""
Production runner for BBC Good Food scraper
"""

import asyncio
from production_scraper import ProductionBBCScraper
...
async def run_production_scraper():
    ...
    print(f"Starting BBC Good Food Production Scraper...")
    ...
    async with ProductionBBCScraper(max_workers=max_workers, delay=delay) as scraper:
